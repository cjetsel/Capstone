<template>
  <div>
    <div class="row button-routes mb-2" v-if="isAdmin">
    ...
    <div class="row button-routes mb-2" v-else>

      <div class="col-12">
        <div class="row justify-content-center">
          <!-- --this should be EDIT, it contains all edit of household info so ?? ask team mystic-- -->
          <div class="col-2 mx-2">
            <router-link :to="{name: 'home', params: {houseId: this.houseId}}">
              <img class="button-img" src="../assets/house.png" alt="">
            </router-link>
            Home
          </div>
          <div class="col-2 mx-2">
            <router-link :to="{name: 'settings', params: {houseId: this.houseId}}">
